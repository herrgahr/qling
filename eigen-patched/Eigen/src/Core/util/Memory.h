...
//---------- Cache sizes ----------
#ifdef EIGEN_QLING_HACK
namespace qlinghack {
void cpuid(int (&abcd)[4], int func, int cache_id);
}
#define EIGEN_CPUID(abcd, func, id) Eigen::qlinghack::cpuid (abcd, func, id)
